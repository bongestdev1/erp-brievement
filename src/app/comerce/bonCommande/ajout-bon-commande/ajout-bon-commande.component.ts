...
export class AjoutBonCommandeComponent implements OnInit {
  ...
  lienGetByIdDocumentPrecedent = "/devisAchats/getById/"
 
  lienGetDocuments = "/bonCommandes/getDevisAchats/"
  ...
  titreDocumentPrecedent = this.fonctionPartagesService.titreDocuments.devisAchat
