...
@Component({
  selector: 'app-facture-achat-list',
  templateUrl: './facture-achat-list.component.html',
  styleUrls: ['./facture-achat-list.component.scss']
})
export class FactureAchatListComponent implements OnInit {


  formBL: FormGroup

  apiDelete = "/factureAchats/deleteFactureAchat"
  apiList = "/factureAchats/listFactureAchats"

  pageDetails = "/factureAchat/details/"
  pageModifie = "/factureAchat/modifier/"
  pageAjoute = "/factureAchat/ajout"
  ...
  items = {
    ...
    numeroFactureVenteFournisseur: "numero facture fournisseur",
    dateFactureVenteFournisseur: "date facture fournisseur"
  };
  ...
  request = {
    ...
    orderBy: {
      ...
      totalTTC: 0,
      totalGain: 0,
      numeroFactureVenteFournisseur: 0,
      dateFactureVenteFournisseur: 0
