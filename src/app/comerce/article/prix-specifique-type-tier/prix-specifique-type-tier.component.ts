...
import { ShemaArticle2 } from '../prix-specifique-article/Models/shema-article2';

@Component({
  selector: 'app-prix-specifique-type-tier',
  templateUrl: './prix-specifique-type-tier.component.html',
  styleUrls: ['./prix-specifique-type-tier.component.scss']
})
export class PrixSpecifiqueTypeTierComponent implements OnInit {
  ...
  lienAjoute = "/prixSpecifiques/newPrixSpecifiqueTypeTier"

  //apiList = "/inventaires/listInventaires"
  lienGetByIdNouvelle = "/articles/getByIdCategorie/"
  lienGetByIdEncienne = "/prixSpecifiques/listPrixSpecifiqueTypetierByCategorie"
