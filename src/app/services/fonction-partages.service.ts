...
export class FonctionPartagesService {
  ...
  titreDocuments = {
    ...
    factureAvoirMarchandises: "facture avoir retour de marchandises",
    factureAvoirFinanciers: "facture avoir retour de financiers",
    factureAvoirSurFacture: "facture avoir retour de Facture",
