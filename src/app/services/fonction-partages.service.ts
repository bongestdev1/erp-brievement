...
export class FonctionPartagesService {
  ...
  colonnesTaux = ["remiseAvoirPourcentage", "margePourcentage", "remiseFacturePourcentage", "tauxFodec", "tauxRemise", "tauxDC", "tauxRemise", "tauxTVA"]
